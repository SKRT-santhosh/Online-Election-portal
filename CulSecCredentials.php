...
<html>
    <head>
	<title>View Credentials : Genereal Secretary</title>
    </head>
...
<div id="body1" style="position:relative;background-color:#FFFFFF;float:left;margin:left:0px;margin-top:10px;width:100%;height:1500px;background-image:url(http://www.noqta.it/dromoscopio/img/pattern_23.gif);">
...
<table border="1" style="border-collapse:collapse;margin-top:10px;margin-left:20px">
		<tr height="250px">
			<td width="40px">1.</td>
			<td width="120px">Candidate #1</td>
			<td width="800px" >
				<ol>
				<li>Credential 1</li>
				<li>Credential 2</li>
